...
<head>
    ...
    <title>Pemilik toko - Dashboard</title>
     ...
     <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/pemiliktoko">
                ...
                <div class="sidebar-brand-text mx-3">pemilik usaha</div>
            </a>
            <!-- Heading -->
            ...
            <li class="nav-item">
                <a class="nav-link" href="/restaurant/bahan">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Bahan</span></a>
            </li>
            <li class="nav-item">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{$profile->nama_pemilik}}</span>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Kasirbos 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
